...
if($_POST['user']&&$_POST['passwd']&&$_POST['phone']&&$_POST['ftpw']&&$_POST['remail']&&$_POST['emhost']&&$_POST['semail']&&$_POST['sepw']&&$_POST['femail']&&$_POST['timerun']&&$_POST['timebetop']&&$_POST['timearmy']&&$_POST['timeall']&&$_POST['runpage']&&$_POST['hfhost']){
...
$sc=str_replace('"TIME_BETOP"',$_POST['timebetop'],$sc);
$sc=str_replace('"TIME_ARMY"',$_POST['timearmy'],$sc);
...
art.dialog.open('hcd/artDialog/login.html', {
    ...
    init: function () {
        ...
        top.document.title = '登錄 - 互粉大廳服務控制後臺面板 - 天狼星の破曉';
    },
    ok: function () {
    	var iframe = this.iframe.contentWindow;
