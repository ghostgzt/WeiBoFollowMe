<?php @include( dirname(__FILE__).'/loadcorn.php' );@include_once('lib_tools.php');if($_GET['del']=='1'){deldir(HF_CRON.'/log');creatdir(HF_CRON.'/log/run');die('所有服務日誌已經被清空~');} ?>
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8"/>
    ...
    <script src="hcd/js/jquery.idTabs.js"></script>
	   <script src="hcd/js/xml.js"></script>
	    <script>
function load(sid,t){
loadXMLDoc('<?php echo HF_CRON;?>/log/'+t+'_'+id+'.txt','content');
}
    </script>
    <style>
