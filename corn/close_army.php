...
die('Corn_Army_'.$_REQUEST['uid'].' 服务完成关闭！');
}else{
die('Corn_Army_'.$_REQUEST['uid'].' 服务沒有運行！');
}
...
xpp('close_army',TIME_ALL);


include( 'config_army.php' );//关闭全部
...
die('Corn_Army 服务完成关闭！');
}else{
die('Corn_Army 服务沒有運行！');
}
