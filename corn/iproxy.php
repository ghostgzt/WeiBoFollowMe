...
if(HF_PROXY!=='1'){
$result= getres(HF_HOST.'index.php?m=ex&visit=1',HF_HOST,null,HF_PROXY);
if($result){
...
$result= getres(HF_HOST.'index.php?m=ex&visit=1',HF_HOST,null,$i_proxy);
if(!$result){
$result= getres(HF_HOST.'index.php?m=ex&visit=1',HF_HOST,null,null);
if(!$result){
for($i=0;$i<count($proxy_list);$i++){
$result= getres(HF_HOST.'index.php?m=ex&visit=1',HF_HOST,null,$proxy_list[$i]);
if($result){
